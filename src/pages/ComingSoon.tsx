...
const ComingSoon = ({
    ...
    const socials = [
        { name: 'Instagram', icon: Instagram, url: 'https://www.instagram.com/rivalioo/', tooltip: 'Follow our visual intel' },
        { name: 'Twitter', icon: Twitter, url: 'https://x.com/rivalioo', tooltip: 'Latest updates & leaks' },
        { name: 'Discord', icon: MessageSquare, url: 'https://discord.gg/rivalioo', tooltip: 'Join the community server' },
        { name: 'YouTube', icon: Youtube, url: 'https://www.youtube.com/@RivaliooYoutube', tooltip: 'Watch gameplay & tutorials' },
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full items-start lg:items-center pb-20">
                        ...
                        >
                            ...
                            <div className="w-full max-w-md flex justify-start gap-4">
                                ...
                                {/* Custom Gift Icon */}
                                <Tooltip text="Rewards" position="top">
                                    <button className="text-gray-600 hover:text-[#2FE9A9] hover:scale-110 transition-all duration-300 bg-[#13161C]/80 p-3 rounded-full border border-white/5 hover:border-[#2FE9A9]/30 block group">
                                        <svg viewBox="0 0 128 128" className="w-5 h-5 stroke-current fill-none stroke-[6px] stroke-linecap-round stroke-linejoin-round">
                                            {/* Box Body */}
                                            <path d="M41,60c0,0,0,23,0,23c0,2.209,1.791,4,4,4h38c2.209,0,4-1.791,4-4c0,0,0-23,0-23h-46Z" transform="translate(0 1)" className="stroke-current" />
                                            <path d="M62,62v23c0,1.105.895,2,2,2s2-.895,2-2v-23Z" transform="translate(0 1)" className="fill-current opacity-50 stroke-current" />

                                            {/* Lid Group (Animates on Hover) */}
                                            <g className="transition-transform duration-500 ease-elastic origin-[64px_50px] group-hover:-rotate-12 group-hover:-translate-y-2">
                                                <path d="M87,46c0,0-46,0-46,0-2.209,0-4,1.791-4,4v10c0,0,54,0,54,0v-10c0-2.209-1.791-4-4-4Z" transform="translate(0 1)" className="stroke-current" />

                                                {/* Bow Group */}
                                                <g>
                                                    <path d="M83,36c-.92-4-5.93-5.28-9.35-3.07C69.73,35.47,66.39,39.62,66,47c3.21-2.68,8.15-2.42,12-3.26c3.41-.91,5.57-4.26,5-7.74Z" transform="translate(0 1)" className="stroke-current" />
                                                    <path d="M54.35,32.93C50.93,30.72,45.92,32,45,36c-.57,3.48,1.59,6.83,5,7.74c3.89.84,8.83.58,12,3.26-.39-7.38-3.73-11.53-7.65-14.07Z" transform="translate(0 1)" className="stroke-current" />
                                                    <path d="M66,59v-15c0-1.105-.895-2-2-2s-2,.895-2,2v15Z" transform="translate(0 1)" className="fill-current opacity-50 stroke-current" />
                                                </g>
                                            </g>
                                        </svg>
                                    </button>
