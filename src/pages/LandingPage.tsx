...
const LandingPage = () => {
    ...
    return (
        <div className="bg-[#0B0E14] min-h-screen font-sans text-white overflow-x-hidden selection:bg-[#2FE9A9] selection:text-black">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={i} className="bg-[#13161C]/50 backdrop-blur-sm p-6 rounded-xl border border-white/5 relative group hover:-translate-y-2 transition-transform duration-300">
                                    {/* Accent Line */}
                        ...
                        <div className="mt-12 flex gap-6">
                            ...
                            <button className="flex items-center gap-2 text-white font-oswald font-bold uppercase tracking-widest text-sm hover:text-[#2FE9A9] transition-colors border border-white/20 px-8 py-4 hover:border-[#2FE9A9] hover:bg-[#2FE9A9]/5" style={{ clipPath: 'polygon(15px 0, 100% 0, 100% calc(100% - 15px), calc(100% - 15px) 100%, 0 100%, 0 15px)' }}>
            ...
            {/* 4. MARKETPLACE */}
            <section className="py-24 bg-[#13161C] border-y border-white/5">
                <div className="container mx-auto px-6">
                    <h2 className="text-4xl font-black uppercase text-white mb-2">The Marketplace</h2>
                    <p className="text-gray-400 text-sm mb-8">Redeem your hard earned coins for premium gaming gear.</p>

                    {/* Filter Tabs */}
                    <div className="flex gap-8 border-b border-white/10 pb-4 mb-8 text-sm font-bold uppercase tracking-wider">
                        <span className="text-white border-b-2 border-[#2FE9A9] pb-4 -mb-4.5 cursor-pointer">Shop</span>
                        <span className="text-gray-500 hover:text-white cursor-pointer">Live</span>
                        <span className="text-gray-500 hover:text-white cursor-pointer">Gift Cards</span>
                        <span className="text-gray-500 hover:text-white cursor-pointer">In-Game Items</span>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        {[1, 2, 3, 4, 5].map((item) => (
                            <div key={item} className="bg-[#0B0E14] border border-white/5 rounded-xl p-4 group hover:border-[#2FE9A9] transition-colors">
                                <div className="h-32 bg-[#1A1D26] rounded-lg mb-4 flex items-center justify-center">
                                    <ShoppingBag className="text-gray-600 group-hover:text-[#2FE9A9] transition-colors" />
                                </div>
                                <h4 className="font-bold text-sm text-white mb-1">Victory Case</h4>
                                <p className="text-[#2FE9A9] font-bold text-xs uppercase mb-3">500 Coins</p>
                                <button className="w-full py-2 bg-[#232732] group-hover:bg-[#2FE9A9] group-hover:text-black text-white text-[10px] font-bold uppercase rounded transition-colors">Redeem</button>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* 7. SQUAD UP & EARN */}
            <section className="py-24 bg-[#13161C] border-t border-white/5">
            ...
            {/* 8. FOOTER CTA */}
            <div className="py-20 text-center bg-[#0B0E14] bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]">
